    ...
    public class LabTestMappingProfile: Profile
    {
        public LabTestMappingProfile()
        {
            CreateMap<LabTestDTO, LabTest>()
                ...
                .ForMember(src => src.Test, opt => opt.MapFrom(opt => opt.Test))
                .ForMember(src => src.Result, opt => opt.MapFrom(opt => opt.Result))
                .ForMember(src => src.Normal, opt => opt.MapFrom(opt => opt.Normal))
