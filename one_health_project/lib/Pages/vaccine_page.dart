...
class VaccinePage extends StatefulWidget {
  static String id = 'vaccine_page';
  @override
  State<VaccinePage> createState() => _VaccinePage();
}
            ...
            body: SingleChildScrollView(
                child: Center(
                    child: Column(
                      ...
                      children: [Center(),
                        SizedBox(height: 20,),
                        Padding(padding: EdgeInsets.symmetric(horizontal: 15), child:Text('Vacuna',textAlign: TextAlign.left, style: TextStyle(color: Colors.white, fontFamily: 'Inter', fontSize: 30,fontWeight: FontWeight.bold),  ),),
                        SizedBox(height: 40,),
                        _vaccineTextField(),
                        SizedBox(height: 20,),
                        Divider(
