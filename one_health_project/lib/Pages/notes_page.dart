            ...
            body: SingleChildScrollView(
                child: Center(
                    child: Column(
                      ...
                      children: [Center(),
                        SizedBox(height: 20,),
                        Padding(padding: EdgeInsets.symmetric(horizontal: 15), child:Text('Notas',textAlign: TextAlign.left, style: TextStyle(color: Colors.white, fontFamily: 'Inter', fontSize: 30,fontWeight: FontWeight.bold),  ),),
                        SizedBox(height: 40,),
                        _TittleTextField(),
                        SizedBox(height: 20,),
                        Divider(
