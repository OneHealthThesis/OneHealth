...
class RadiologyPage extends StatefulWidget {
  static String id = 'radiology_page';
  @override
  State<RadiologyPage> createState() => _RadiologyPage();
}

class _RadiologyPage extends State<RadiologyPage> {
  @override
            ...
            body: SingleChildScrollView(
                child: Center(
                    child: Column(
                      ...
                      children: [Center(),
                        SizedBox(height: 20,),
                        Padding(padding: EdgeInsets.symmetric(horizontal: 15), child:Text('Radiología',textAlign: TextAlign.left, style: TextStyle(color: Colors.white, fontFamily: 'Inter', fontSize: 30,fontWeight: FontWeight.bold),  ),),
                        SizedBox(height: 40,),
                        _tittleTextField(),
                        SizedBox(height: 20,),
                        _resultTextField(),
