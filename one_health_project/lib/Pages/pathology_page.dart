...
class PathologyPage extends StatefulWidget {
  static String id = 'pathology_page';
  @override
  State<PathologyPage> createState() => _PathologyPage();
}

class _PathologyPage extends State<PathologyPage> {
  @override
            ...
            body: SingleChildScrollView(
                child: Center(
                    child: Column(
                      ...
                      children: [Center(),
                        SizedBox(height: 20,),
                        Padding(padding: EdgeInsets.symmetric(horizontal: 15), child:Text('Patología',textAlign: TextAlign.left, style: TextStyle(color: Colors.white, fontFamily: 'Inter', fontSize: 30,fontWeight: FontWeight.bold),  ),),
                        SizedBox(height: 40,),
                        _tittleTextField(),
                        SizedBox(height: 20,),
                        _resultTextField(),
