...
class AddingPetPage extends StatefulWidget {
  static String id = 'adding_pet_page';
  @override
  State<AddingPetPage> createState() => _AddingPetPage();
}

class _AddingPetPage extends State<AddingPetPage> {
  @override
