...
class LabTestPage extends StatefulWidget {
  static String id = 'lab_tests_page';
  @override
  State<LabTestPage> createState() => _LabTestPage();
}

class _LabTestPage extends State<LabTestPage> {
  @override
            ...
            body: SingleChildScrollView(
                child: Center(
                    child: Column(
                      ...
                      children: [Center(),
                        SizedBox(height: 20,),
                        Padding(padding: EdgeInsets.symmetric(horizontal: 15), child:Text('Prueba de Laboratorio',textAlign: TextAlign.left, style: TextStyle(color: Colors.white, fontFamily: 'Inter', fontSize: 30,fontWeight: FontWeight.bold),  ),),
                        SizedBox(height: 40,),
                        _testTextField(),
                        SizedBox(height: 20,),
                        _resultTextField(),
