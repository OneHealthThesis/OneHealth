...
class OxygenPage extends StatefulWidget {
  static String id = 'oxygen_page';
  @override
  State<OxygenPage> createState() => _OxygenPage();
}

class _OxygenPage extends State<OxygenPage> {
  @override
            ...
            body: SingleChildScrollView(
                child: Center(
                    child: Column(
                      ...
                      children: [Center(),
                        SizedBox(height: 20,),
                        Padding(padding: EdgeInsets.symmetric(horizontal: 15), child:Text('Oxígeno',textAlign: TextAlign.left, style: TextStyle(color: Colors.white, fontFamily: 'Inter', fontSize: 30,fontWeight: FontWeight.bold),  ),),
                        SizedBox(height: 40,),
                        _resultTextField(),
                        SizedBox(height: 20,),
                        _pulseTextField(),
