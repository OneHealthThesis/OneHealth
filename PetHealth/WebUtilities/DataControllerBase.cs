...
namespace PetHealth.WebUtilities
{
    ...
    public abstract class DataControllerBase<TContext, TEntity, TDTO, TKey> : ControllerBase
        where TContext : IPetHealthContext
        ...
        where TEntity : class, IEntity<TKey>
    {
        ...
        /// </value>
        protected IDataService<TContext> DataService { get; }
        ...
        protected DataControllerBase(IDataService<TContext> dataService, IDataHandler dataHandler = null)
        {
    ...
    /// </summary>
    /// <inheritdoc/>
    public abstract class DataControllerBase<TEntity, TDTO, TKey> : DataControllerBase<IPetHealthContext, TEntity, TDTO, TKey>
        where TDTO : class, IDTO<TKey>
        where TKey : IEquatable<TKey>
        where TEntity : class, IEntity<TKey>
    {
        /// <inheritdoc/>
        protected DataControllerBase(IDataService<IPetHealthContext> dataService, IDataHandler dataHandler = null)
    ...
    /// </summary>
    /// <inheritdoc/>    
    public abstract class DataControllerBase<TEntity, TDTO> : DataControllerBase<IPetHealthContext, TEntity, TDTO, int>
